...
export interface EnvironmentApi {
  ...
  projects: {
    ...
    readDiagnostics: (input: ProjectReadDiagnosticsInput) => Promise<ProjectReadDiagnosticsResult>;
    ...
    ) => Promise<ProjectLanguageServerStartResult>;
    stopLanguageServer: (
      input: ProjectLanguageServerStopInput,
    ) => Promise<ProjectLanguageServerStopResult>;
    syncLanguageServerDocument: (input: ProjectLanguageServerDocumentSyncInput) => Promise<void>;
    hoverLanguageServer: (
      input: ProjectLanguageServerPositionInput,
    ) => Promise<ProjectLanguageServerHoverResult>;
    definitionLanguageServer: (
      input: ProjectLanguageServerPositionInput,
    ) => Promise<ProjectLanguageServerDefinitionResult>;
    referencesLanguageServer: (
      input: ProjectLanguageServerPositionInput,
    ) => Promise<ProjectLanguageServerReferencesResult>;
    completionLanguageServer: (
      input: ProjectLanguageServerPositionInput,
