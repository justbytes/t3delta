...
import { parseScopedThreadKey, scopedThreadKey } from "@t3delta/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@t3delta/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "t3delta:terminal-state:v1";
