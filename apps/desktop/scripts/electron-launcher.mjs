// This file mostly exists because we want dev mode to say "t3delta (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "t3delta (Dev)" : "t3delta (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "gg.colosseum.desktop.dev" : "gg.colosseum.desktop";
...
const developmentMacIconPngPath = join(repoRoot, "assets", "dev", "t3delta-dev-macos-1024.png");
