...
import type { ChatAttachment, ModelSelection } from "@t3delta/contracts";

import type { TextGenerationError } from "@t3delta/contracts";

/** Providers that support git text generation (commit messages, PR content, branch names). */
export type TextGenerationProvider = "hermes" | "codex" | "claudeAgent";
