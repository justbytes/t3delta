...
export const CLIENT_SETTINGS_STORAGE_KEY = "t3delta:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "t3delta:saved-environment-registry:v1";
