...
import { CheckpointRef } from "@t3delta/contracts";
    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "T3 Delta",
          GIT_AUTHOR_EMAIL: "t3delta@users.noreply.github.com",
          GIT_COMMITTER_NAME: "T3 Delta",
          GIT_COMMITTER_EMAIL: "t3delta@users.noreply.github.com",
        };
