import type { EnvironmentId, EnvironmentApi } from "@t3delta/contracts";
...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    projects: {
      ...
      readDiagnostics: rpcClient.projects.readDiagnostics,
      ...
      startLanguageServer: rpcClient.projects.startLanguageServer,
      stopLanguageServer: rpcClient.projects.stopLanguageServer,
      syncLanguageServerDocument: rpcClient.projects.syncLanguageServerDocument,
      hoverLanguageServer: rpcClient.projects.hoverLanguageServer,
      definitionLanguageServer: rpcClient.projects.definitionLanguageServer,
      referencesLanguageServer: rpcClient.projects.referencesLanguageServer,
      completionLanguageServer: rpcClient.projects.completionLanguageServer,
      renameLanguageServer: rpcClient.projects.renameLanguageServer,
      codeActionsLanguageServer: rpcClient.projects.codeActionsLanguageServer,
      onLanguageServerEvent: rpcClient.projects.onLanguageServerEvent,
    },
    filesystem: {
