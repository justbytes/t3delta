import type { GitStatusRemoteResult, GitStatusResult } from "@t3delta/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:justbytes/t3delta.git")).toBe(
      "github.com/justbytes/t3delta",
    );
    expect(normalizeGitRemoteUrl("https://github.com/justbytes/t3delta.git")).toBe(
      "github.com/justbytes/t3delta",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/justbytes/t3delta")).toBe(
      "github.com/justbytes/t3delta",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:justbytes/platform/t3delta.git")).toBe(
      "gitlab.com/justbytes/platform/t3delta",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/justbytes/platform/t3delta.git")).toBe(
      "gitlab.com/justbytes/platform/t3delta",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:justbytes/t3delta.git"),
    ).toBe("justbytes/t3delta");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/justbytes/t3delta.git"),
    ).toBe("justbytes/t3delta");
  });
});
