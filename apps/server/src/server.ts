...
import { CodexProviderLive } from "./provider/Layers/CodexProvider.ts";
...
import { HermesGatewayManagerLive } from "./hermesGatewayManager.ts";
import { ProjectFaviconResolverLive } from "./project/Layers/ProjectFaviconResolver.ts";
import { RepositoryIdentityResolverLive } from "./project/Layers/RepositoryIdentityResolver.ts";
import { WorkspaceEntriesLive } from "./workspace/Layers/WorkspaceEntries.ts";
import { WorkspaceDiagnosticsLive } from "./workspace/Layers/WorkspaceDiagnostics.ts";
import { WorkspaceFileSystemLive } from "./workspace/Layers/WorkspaceFileSystem.ts";
import { WorkspaceLanguageServersLive } from "./workspace/Layers/WorkspaceLanguageServers.ts";
...
const ProviderLayerLive = Layer.unwrap(
  Effect.gen(function* () {
    ...
    const adapterRegistryLayer = ProviderAdapterRegistryLive.pipe(
      ...
      Layer.provide(HermesGatewayManagerLive),
...
const RuntimeDependenciesLive = ReactorLayerLive.pipe(
  ...
  Layer.provideMerge(ProviderRegistryLive.pipe(Layer.provide(CodexProviderLive))),
  Layer.provideMerge(ServerSettingsLive),
...
export const runServer: Effect.Effect<never, Error, ServerConfig> = Layer.launch(makeServerLayer);
