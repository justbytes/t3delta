...
import { CodexModelSelection } from "@t3delta/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@t3delta/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `t3delta-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
