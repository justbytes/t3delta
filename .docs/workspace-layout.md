...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@t3delta/shared/git`, `@t3delta/shared/DrainableWorker`) — no barrel index.
