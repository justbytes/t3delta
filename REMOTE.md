...
Use this when you want to connect to a T3 Delta server from another device such as a phone, tablet, or separate desktop app.
...
```bash
npx delta serve --host "$(tailscale ip -4)"
```
