import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@t3delta/contracts";
...
import { KeybindingsConfigError } from "@t3delta/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "t3delta-keybindings-test-",
        }),
      ),
    ),
  );
