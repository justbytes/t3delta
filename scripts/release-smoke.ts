...
files:
  - url: T3-Delta-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: T3-Delta-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: T3-Delta-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: T3-Delta-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: T3-Delta-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: T3-Delta-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
function writeWindowsManifestFixtures(
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: T3-Delta-9.9.9-smoke.0-arm64.exe
    sha512: arm64exe
    size: 126621344
  - url: T3-Delta-9.9.9-smoke.0-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 152344
path: T3-Delta-9.9.9-smoke.0-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-08T10:32:14.587Z'
`,
  );
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: T3-Delta-9.9.9-smoke.0-x64.exe
    sha512: x64exe
    size: 132000112
  - url: T3-Delta-9.9.9-smoke.0-x64.exe.blockmap
    sha512: x64blockmap
    size: 160112
path: T3-Delta-9.9.9-smoke.0-x64.exe
sha512: x64exe
releaseDate: '2026-03-08T10:36:07.540Z'
`,
  );
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=T3 Delta Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    mergedManifest,
    "T3-Delta-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "T3-Delta-9.9.9-smoke.0-x64.zip",
    ...
    [
      ...
      `
        ...
        for x64_manifest in "$release_assets_dir"/*-win-x64.yml; do
          ...
          bun ${JSON.stringify(resolve(repoRoot, "scripts/merge-update-manifests.ts"))} --platform win \
            "$arm64_manifest" \
            "$x64_manifest" \
            "$output_manifest"
  ...
  assertContains(
    ...
    "T3-Delta-9.9.9-smoke.0-arm64.exe",
